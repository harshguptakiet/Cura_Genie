  ...
  return (
    <div className="space-y-10">
      ...
      {dashboardData.isOffline && (
        <div className="flex items-center gap-2 text-amber-700 bg-amber-50/90 rounded-lg px-4 py-2 text-sm border border-amber-200/80">
      ...
      {/* Welcome Header */}
      <div className="relative bg-gradient-to-r from-slate-200 to-slate-100 text-slate-900 rounded-2xl p-8 overflow-hidden shadow-[0_18px_40px_rgba(15,23,42,0.08)] ring-1 ring-slate-200/90">
        <div className="absolute inset-0 bg-gradient-to-r from-white/40 to-slate-100/55"></div>
        <div className="absolute top-0 right-0 w-32 h-32 bg-slate-300/35 rounded-full -translate-y-16 translate-x-16"></div>
        <div className="absolute bottom-0 left-0 w-24 h-24 bg-slate-300/25 rounded-full translate-y-12 -translate-x-12"></div>
        
        <div className="relative z-10 flex items-center justify-between">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <h1 className="text-4xl font-semibold tracking-tight mb-2 text-slate-900">
            ...
            <div className="flex items-center gap-4 pt-2">
              <div className="flex items-center gap-2 text-slate-700 bg-white/75 px-3 py-1 rounded-full ring-1 ring-slate-300/80">
          ...
          <div className="hidden lg:block">
            <div className="relative">
              <div className="absolute inset-0 bg-slate-400/30 rounded-full blur-xl opacity-70"></div>
              <Sparkles className="h-20 w-20 text-slate-700 relative z-10" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
        {quickStats.map((stat, index) => {
          ...
          return (
            <Card key={index} className="transition-all duration-200 hover:shadow-[0_12px_26px_rgba(15,23,42,0.1)] hover:-translate-y-0.5 border border-slate-200/70 overflow-hidden">
              <div className="absolute h-1 top-0 left-0 right-0 bg-gradient-to-r from-sky-500 to-indigo-600 opacity-70"></div>
      ...
      {!hasData && (
        <Card className="border-2 border-dashed border-sky-200 bg-sky-50/40 hover:border-sky-300 hover:bg-sky-50/55 transition-all duration-200 shadow-sm hover:shadow-md">
            ...
            <div className="flex flex-col items-center space-y-4">
              ...
              <div>
                ...
                <Button 
                  ...
                  className="bg-sky-600 hover:bg-sky-700 transition-all duration-200 shadow-md hover:shadow-lg"
                >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
        <Card className="transition-all duration-200 hover:shadow-[0_12px_26px_rgba(15,23,42,0.1)] hover:-translate-y-0.5 bg-gradient-to-br from-white to-sky-50 border border-sky-100">
          <CardContent className="p-6">
            <div className="flex items-start space-x-4">
              <div className="p-3 bg-sky-100 rounded-lg shadow-inner">
                <Upload className="h-6 w-6 text-sky-600" />
              </div>
              <div className="flex-1">
                <h3 className="font-semibold tracking-tight text-slate-900 mb-1">Upload & Analyze</h3>
        ...
        <Card className="transition-all duration-200 hover:shadow-[0_12px_26px_rgba(15,23,42,0.1)] hover:-translate-y-0.5 bg-gradient-to-br from-white to-emerald-50 border border-emerald-100">
          <CardContent className="p-6">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                <h3 className="font-semibold tracking-tight text-slate-900 mb-1">Explore Results</h3>
                <p className="text-sm text-slate-600 mb-3">
      ...
      {hasData && (
        <Card className="mt-12 border border-slate-200/70 shadow-md hover:shadow-[0_14px_30px_rgba(15,23,42,0.1)] transition-all duration-200">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              <TabsContent value="scores" className="mt-6">
                <div className="space-y-4">
                  <div className="border-l-4 border-blue-500 pl-4">
                    <h4 className="font-semibold text-slate-900 mb-1">Polygenic Risk Scores (PRS)</h4>
              ...
              <TabsContent value="recommendations" className="mt-6">
                <div className="space-y-4">
                  <div className="border-l-4 border-green-500 pl-4">
                    <h4 className="font-semibold text-slate-900 mb-1">Personalized Health Recommendations</h4>
                    <p className="text-sm text-slate-600">
              ...
              <TabsContent value="assessments" className="mt-6">
                <div className="space-y-6">
                  <div className="border-l-4 border-purple-500 pl-4 mb-6">
                    <h4 className="font-semibold text-slate-900 mb-1">Clinical Risk Assessments</h4>
                    <p className="text-sm text-slate-600">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
        <Card className="text-center p-6 border border-slate-200/70 hover:shadow-[0_12px_26px_rgba(15,23,42,0.1)] transition-all duration-200 hover:-translate-y-0.5">
          ...
          <h3 className="font-semibold tracking-tight text-slate-900 mb-2">AI-Powered Analysis</h3>
          <p className="text-sm text-slate-600">
        ...
        <Card className="text-center p-6 border border-slate-200/70 hover:shadow-[0_12px_26px_rgba(15,23,42,0.1)] transition-all duration-200 hover:-translate-y-0.5">
          <div className="relative w-24 h-24 mx-auto mb-6">
            <div className="absolute inset-0 bg-green-200 rounded-full opacity-50"></div>
            <div className="relative flex items-center justify-center h-full">
              <Shield className="h-12 w-12 text-green-600" />
            </div>
          </div>
          <h3 className="font-semibold tracking-tight text-slate-900 mb-2">Privacy First</h3>
          <p className="text-sm text-slate-600">
        ...
        <Card className="text-center p-6 border border-slate-200/70 hover:shadow-[0_12px_26px_rgba(15,23,42,0.1)] transition-all duration-200 hover:-translate-y-0.5">
          ...
          <h3 className="font-semibold tracking-tight text-slate-900 mb-2">Detailed Reports</h3>
          <p className="text-sm text-slate-600">
